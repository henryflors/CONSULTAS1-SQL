--ejercicio 1: Dada la tabla de reseñas
...
--ejercicio 5: Imagina que eres un analista de datos que trabaja en CVS Pharmacy y tienes acceso a los datos de ventas de la farmacia.
...
--ejercicio 29: Dada una tabla de publicaciones de Facebook, para cada usuario que publicó al menos dos veces en 2021, escribe una consulta para encontrar la cantidad de días entre la primera publicación del año y la última publicación del año de cada usuario en el año 2021. 
SELECT 
	user_id, 
